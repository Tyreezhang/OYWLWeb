...
namespace OYWebSite
{
    public partial class List : BasicSecurity
    {
        ...
        private void BindGrid(string sortfield, string sort)
        {
            ...
            whr += " and IsDel=0 and IsAudit=1 and IsPrint=1 ";
        ...
        protected void itemlist_RowClick(object sender, FineUI.GridRowClickEventArgs e)
        {
            ...
            Ords.DataBind();
            Statuslist.DataSource = Ultra.WindowsControl.Caller.SerNoCaller.Calr_FollowTrack.Get("select * from T_ERP_FollowTrack where TrackMsgGuid=@0", rowDataKeys[2].ToString());
            Statuslist.DataBind();
        }
