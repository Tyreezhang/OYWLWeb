<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnRebateslist.aspx.cs" Inherits="OYWebSite.UnRebateslist" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid ID="itemlist" PageSize="10" Title="表格" Height="350px" EnableCollapse="true" CssStyle="left:10px;top:5px;" Width="1120px" ShowBorder="true" ShowHeader="false" OnSort="itemlist_Sort" SortDirection="ASC" AllowSorting="true"
            ...
            <Columns>
                ...
                <f:BoundField Width="150px" DataField="Departure" HeaderText="起运地" DataFormatString="{0}" DataToolTipField="Departure" SortField="Departure" />
                <f:BoundField Width="150px" DataField="Arrival" DataFormatString="{0}" HeaderText="到达地" DataToolTipField="Arrival" SortField="Arrival" />
