<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Companyfeatures.aspx.cs" Inherits="OYWebSite.Companyfeatures" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="top">
            <div class="public_box">
                <div class="font_nav">
                    ...
                    <a href="../Companyfeatures.aspx" style="background: #ff9e40;">
        ...
        <div class="public_box">
            <div class="Ps_left">
                <img src="images/公司简介侧栏底.png" />
                <ul>
                    <li id="one" style="background-color: #2E2D29;"><span style="font-size: 12px;">●</span>  <span>企业简介</span></li>
                </ul>
            </div>
            <div class="Ps_mid">
                <!--公司简介-->
                <div style="margin-top: 20px; width: 937px;">
                    <span style="font-family: '微软雅黑'; font-size: 30px; color: #CD2D2D; font-weight: bold;">公</span><span style="font-family: '微软雅黑'; font-size: 20px; font-weight: bold;">司简介/</span><span style="font-family: '微软雅黑'; font-size: 15px; font-weight: bold;">Company style</span>
                    <hr />
                </div>
                <div style="width: 937px; display: block;">
                    <img src="images/公司简介.png" width="937" />
                </div>

                <!--员工生活-->
                <div style="margin-top: 20px; width: 937px;">
                    <span style="font-family: '微软雅黑'; font-size: 30px; color: #CD2D2D; font-weight: bold;">员</span><span style="font-family: '微软雅黑'; font-size: 20px; font-weight: bold;">工生活/</span><span style="font-family: '微软雅黑'; font-size: 15px; font-weight: bold;">Staff of life</span>
                    <hr />
                </div>
                <div style="width: 937px; display: block;">
                    <img src="images/员工生活.png" width="937" />
                </div>

                <!--服务品质-->
                <div style="margin-top: 20px; width: 937px;">
                    <span style="font-family: '微软雅黑'; font-size: 30px; color: #CD2D2D; font-weight: bold;">服</span><span style="font-family: '微软雅黑'; font-size: 20px; font-weight: bold;">务品质/</span><span style="font-family: '微软雅黑'; font-size: 15px; font-weight: bold;">Quality of Service</span>
                    <hr />
                </div>
                <div style="width: 937px; display: block;">
                    <img src="images/服务品质.png" width="937" />
                </div>
            </div>
        </div>
