<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contactus.aspx.cs" Inherits="OYWebSite.Contactus" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="top">
            <div class="public_box">
                <div class="font_nav">
                    ...
                    <a href="../Contactus.aspx" style="background: #ff9e40;">
        ...
        <div class="public_box">
            <div class="Ps_left">
                <img src="images/联系我们侧栏底.png" />
                <ul>
                    <li id="one" style="background-color: #2E2D29;"><span style="font-size: 12px;">●</span>  <span>联系我们</span></li>
                </ul>
            </div>
            <div class="Ps_mid">
                <div style="margin-top: 20px; width: 937px;">
                    <span style="font-family: '微软雅黑'; font-size: 30px; color: #CD2D2D; font-weight: bold;">联</span><span style="font-family: '微软雅黑'; font-size: 20px; font-weight: bold;">系我们/</span><span style="font-family: '微软雅黑'; font-size: 15px; font-weight: bold;">Successful case</span>
                    <hr />
                </div>
                <div style="width: 937px;">
                    <img src="images/联系我们.png" width="937" />
                </div>
                <span style="font-size: 28px;">欧洋物流</span>
                <div style="margin-top: -10px; line-height: 25px;">
                    <br />
                    乐从总部办公室：顺德区乐从镇顺联北区家私城10座后面<br />
                    联系电话：0757-28332658<br />
                    传      真：0757-28851958  
                    <br />
                    乐从总部仓库：乐从镇上华兴隆物流园5号仓<br />
                    联系电话：0757-28851958
                    <br />
                </div>
                <br />
                <br />
                <span style="font-size: 28px;">各公司联系方式</span>
                <div style="margin-top: -10px; line-height: 25px;">
                    <br />
                    万州地址：万州区北滨路小天鹅下边水晶郦城旁                
                    <br />
                    电      话：15823720356   李生                
                    <br />
                    中山地址：中山市古镇曹二均都沙新工业区(古神公路旁)                
                    <br />
                    联系电话：0760-87878260                   
                    <br />
                    顺德容桂（分部）：容桂镇细滘物流中心北门7-8号                
                    <br />
                    联系电话：0757-22115617                  
                    <br />
                    手      机：15813155713   贺生                
                    <br />
                    禅城南庄（分部）：南庄镇紫洞路易运物流园B栋5-6号                
                    <br />
                    联系电话：0757-82519293                
                    <br />
                </div>
                ...
                <br />
                <div style="width: 937px;">
                    <img src="images/地图.png" width="937" />
                </div>
            </div>
        </div>
