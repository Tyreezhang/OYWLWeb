<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="OYWebSite.List" %>
...
<body style="background: #FFFFFF;">
    <form id="form1" runat="server">
        ...
        <f:Grid ID="itemlist" PageSize="10" Title="表格" Height="320px" EnableCollapse="true" CssStyle="left:10px;top:5px;" Width="1120px" ShowBorder="true" ShowHeader="false" OnSort="itemlist_Sort" SortDirection="ASC" AllowSorting="true"
            ...
            <Columns>
                ...
                <f:BoundField Width="180px" DataField="Departure" HeaderText="起运地" DataFormatString="{0}" DataToolTipField="Departure" SortField="Departure" />
                <f:BoundField Width="185px" DataField="Arrival" DataFormatString="{0}" HeaderText="到达地" DataToolTipField="Arrival" SortField="Arrival" />
                ...
                <f:BoundField Width="120px" DataField="ReceiverMobile" DataFormatString="{0}" HeaderText="收货人电话" DataToolTipField="ReceiverMobile" SortField="ReceiverMobile" />
                <f:BoundField Width="100px" DataField="Freight" DataFormatString="{0}" HeaderText="运费" DataToolTipField="Freight" SortField="Freight" />
        ...
        <f:TabStrip ID="TabStrip" CssClass="Tab" CssStyle="left:10px;top:5px;" Width="1120px" Height="185px" ShowBorder="true" TabPosition="Top"
            EnableTabCloseMenu="false" AutoPostBack="true" ActiveTabIndex="0"
            runat="server">
            <Tabs>
                <f:Tab ID="Tab1" Title="货运状态" Layout="Fit"
                    runat="server">
                    <Items>
                        <f:Grid ID="Statuslist" Title="表格" Height="185px" EnableCollapse="true" Width="1120px" ShowBorder="true" ShowHeader="false"
                            EnableTextSelection="true" runat="server">
                            <Columns>
                                <f:RowNumberField EnablePagingNumber="true" Width="30px" />
                                <f:BoundField Width="120px" DataField="TrackTime" HeaderText="处理时间" SortField="TrackTime" DataFormatString="{0:yyyy-MM-dd}" DataToolTipField="TrackTime" DataToolTipFormatString="{0:yyyy-MM-dd}" />
                                <f:BoundField Width="400px" DataField="TrackMessage" DataFormatString="{0}" HeaderText="运单记录" DataToolTipField="TrackMessage" />
                            </Columns>
                        </f:Grid>
                    </Items>
                </f:Tab>
                <f:Tab ID="Tab3" Title="商品明细" Layout="Fit" runat="server">
                    <Items>
                        <f:Grid ID="Ords" Height="185px" EnableCollapse="true" EnableTextSelection="true" Width="1120px" ShowBorder="true" ShowHeader="false"
                            runat="server">
                            <Columns>
                                <f:RowNumberField />
                                ...
                                <f:BoundField Width="60px" DataField="Packcount" HeaderText="件数" DataFormatString="{0}" DataToolTipField="Packcount" />
