<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Announcement.aspx.cs" Inherits="OYWebSite.Announcement" %>
...
<div class="top_head">
    ...
    <form id="form1" runat="server">
        ...
        <div class="public_box">
            <div class="Ps_left">
                <img src="images/活动公告侧栏底.png" />
                <ul>
                    <li id="one" style="background-color: #2E2D29;"><span style="font-size: 12px;">●</span>  <span>活动公告</span></li>
                </ul>
            </div>
            <div class="Ps_mid">
                <div style="margin-top: 20px; width: 937px;">
                    <span style="font-family: '微软雅黑'; font-size: 30px; color: #CD2D2D; font-weight: bold;">市</span><span style="font-family: '微软雅黑'; font-size: 20px; font-weight: bold;">场活动/</span><span style="font-family: '微软雅黑'; font-size: 15px; font-weight: bold;">Market activity</span>
                    <hr />
                </div>
                <div style="width: 937px; display: block;">
                    <h3 style="text-align: center">钜惠国庆  放价到底</h3>
                    <p>
                    </p>
                </div>
            </div>
